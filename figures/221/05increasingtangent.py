...
def tangent(t):
    ...
    annotate([t, yt], [-4*m/sqm, 4/sqm] , makeboxc(labels[t+1]) )
#setViewBox, openOutputFile
setViewBox(-1.6, -1.0, 3.01, 3.0)
openOutputFile("05increasingtangent", 90)
...
for k in range(-1, 3):
    tangent(k)
#annotations
annotate([1,1.4], [0,14], makeboxc(r"\footnotesize $f'(x)$ increasing") )
